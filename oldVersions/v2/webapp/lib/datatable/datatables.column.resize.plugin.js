...
ColReorder.prototype = {
	...
	"_fnConstruct": function ()
	{
		...
		/* Drop callback initialisation option */
		if ( typeof this.s.init.resizeCallBack != 'undefined' )
		{
			this.s.resizeCallBack = this.s.init.resizeCallBack;
		}
		...
		if (this.dom.resize) {       
		  ...
		  if($('div.dataTables_scrollBody', this.s.dt.nTableWrapper) != null){
			...
			if($('div.dataTables_scrollBody', this.s.dt.nTableWrapper).length > 0){
				...
				$($(tableScroller)[0].childNodes[0]).css("width", '');
				$("div.dataTables_scrollHeadInner table", this.s.dt.nTableWrapper).css("width", '');
			}
		  }
		  ////////////////////////
	...
	"_fnMouseUp": function ( e, colResized)
	{
		...
		//Martin Marchetta
			...
			this.s.dt.oInstance.oApi._fnSaveState( this.s.dt );
			this.s.dt.oInstance.fnAdjustColumnSizing();
			//$(this.s.dt.oInstance).trigger("resize");
		}
		///////////////////////////////////////////////////////
